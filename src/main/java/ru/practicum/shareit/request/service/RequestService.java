...
public class RequestService implements RequestServiceInterface {
    ...
    @Override
    @Transactional(readOnly = true)
    public Collection<RequestAnswerDto> getAllOtherUsersRequests(int userId, Pageable pageable) {
        User user = userService.getUserById(userId);
        Collection<Request> otherUsersRequests = requestStorage.findRequestsByRequestorNot(user, pageable);
